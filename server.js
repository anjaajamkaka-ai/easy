// =============================================================================
// Easy Cheats — API com sistema de Revendedores
// =============================================================================
...
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'easycheats2024';
...
// Health check
app.get('/', (req, res) => res.json({ status: 'ok', message: 'Easy Cheats API running' }));

app.listen(PORT, () => console.log(`Easy Cheats API na porta ${PORT}`));
